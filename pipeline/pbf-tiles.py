...
build.mjs cannot tell the difference. Nairobi: the city and its satellite
towns, 52 x 55 km, out of the Geofabrik Kenya extract in one pass.
...
PBFS = [os.path.join(ROOT, 'data', 'kenya-latest.osm.pbf')]

# must match pipeline/download.sh and build.mjs
S, N, W, E = -1.50, -1.02, 36.60, 37.10
RAIL_BOX = (-1.50, 36.60, -1.02, 37.10)
...
rail_file = os.path.join(ROOT, 'data/osm/nairobi-rail.json')
...
GEN = 'pbf-tiles.py (Geofabrik kenya)'
